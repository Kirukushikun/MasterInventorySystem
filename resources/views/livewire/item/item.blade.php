<div class="card">
  ...
  <form wire:submit.prevent method="post">
    ...
    <div class="card-body">
      <div class="form-group row">
        ...
        <div class="col-sm-1">
          <a onclick="openCategoryInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
        </div>
        ...
        @if(!is_null($category_id) || $category_id != null)
          ...
          <div class="col-sm-1">
            <a onclick="openSubCategoryInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
          </div>
          ...
          @if((!is_null($category_id) || $category_id != null) && (!is_null($subcategory_id) || $subcategory_id != null))
            ...
            <div class="col-sm-1">
              <a onclick="openProductInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
            </div>
            ...
            @if((!is_null($category_id) || $category_id != null) &&
              ...
              <div class="col-sm-1">
                <a onclick="openItemNameInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
              </div>
              ...
              @if((!is_null($item_name_id) || $item_name_id != null))
                ...
                <div class="col-sm-1">
                  <a onclick="openBinLocationInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
                </div>
                ...
                <div class="col-sm-1">
                  <a onclick="openSupplierInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
                </div>
                ...
                <label for="" class="col-sm-1 col-form-label text-right text-wrap">{{ $this->temp_quantity == 0 ? __('Quantity') : __('Additional Quantity') }}<span class="text-danger"> *</span></label>
                <div class="col-sm-5">
                ...
                <div class="col-sm-1">
                  <a onclick="openUomInNewTab();" style="width: 100%;" class="btn btn-primary text-primary"><i class="fas fa-plus text-primary"></i></a>
                </div>
                ...
                <label for="" class="col-sm-1 col-form-label text-right text-wrap">{{ __('Purchase/Total Cost') }}</label>
                <div class="col-sm-3">
  ...
  <div class="col-md-2 ml-auto">
    <button id="showNotif" class="btn btn-primary text-center form-control" {{-- @if($this->quantity_to_add == 0) disabled @endif --}}>
