<div class="card">
  <form wire:submit.prevent method="post">
    ...
    <div class="card-body">
      <div class="form-group row">
        <label for="" class="col-sm-2 col-form-label text-right">{{ __('Notification Type') }}<span class="text-danger"> *</span></label>
        <div class="col-sm-3">
          <input type="text" class="form-control @error('name') is-invalid @enderror 
          {{ session()->has('already_exist')? 'is-invalid' : '' }}" autofocus placeholder="Notification Type" wire:model="name" placeholder="Notfication">
  ...
  <div class="col-md-4 ml-auto">
    <a href="{{ route('alert.type.list') }}" class="btn btn-danger"><i class="fas fa-times"></i> Cancel</a>
