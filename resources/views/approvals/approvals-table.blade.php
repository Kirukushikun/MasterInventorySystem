		...
		<div class="row">
			<div class="col-md-12">
				<div class="header">
					<h4 class="title">
						{{ __('APPROVALS LIST') }}
						<a href="{{ route('approvals.div') }}" class="btn btn-primary text-primary">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
                                <table id="approvals" class="table table-hover" style="width: 100%;">
                                    <thead>
...
@section('scriptss')
	...
	<script>
        ...
        $(document).ready(function () {
            approvals = jQuery('#approvals').DataTable({
                processing: true,
                serverSide: false,
                scrollX: true,
                columnDefs: [
        ...
        $(document).on('click', '#refresh', function(e) {
            approvals = $('#approvals').DataTable();
                $('#series_location').val('');
            var nurl = "/farm/location/list/all/fl/rf";
            approvals.ajax.url(nurl).load();
