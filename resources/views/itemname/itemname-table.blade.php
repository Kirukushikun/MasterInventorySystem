		...
		<div class="row">
			<div class="col-md-12">
				<div class="header">
					<h4 class="title">
						{{ __('Item Name List') }}
						<a href="{{ route('itemname.div') }}" class="btn btn-primary text-primary">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
                                <table id="itemname" class="table table-hover" style="width: 100%;">
                                    <thead>
...
@section('scriptss')
	...
	<script>
        ...
        $(document).ready(function () {
            itemname = jQuery('#itemname').DataTable({
                processing: true,
                serverSide: false,
                scrollX: true,
                columnDefs: [
        ...
        $(document).on('click', '#refresh', function(e) {
            itemname = $('#itemname').DataTable();
                $('#series_location').val('');
            var nurl = "/farm/location/list/all/fl/rf";
            itemname.ajax.url(nurl).load();
