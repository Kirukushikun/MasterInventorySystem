		...
		<div class="row">
			<div class="col-md-12">
				<div class="header">
					<h4 class="title">
						{{ __('SUB CATEGORY LIST') }}
						<a href="{{ route('subcategory.div') }}" class="btn btn-primary text-primary">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
                                <table id="subcategory" class="table table-hover" style="width: 100%;">
                                    <thead>
...
@section('scriptss')
	...
	<script>
        ...
        $(document).ready(function () {
            subcategory = jQuery('#subcategory').DataTable({
                processing: true,
                serverSide: false,
                scrollX: true,
                columnDefs: [
        ...
        $(document).on('click', '#refresh', function(e) {
            ...
            subcategory.ajax.url(nurl).load();
