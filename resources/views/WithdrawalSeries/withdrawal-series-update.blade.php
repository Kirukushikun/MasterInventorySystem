	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="header">
					<h4 class="title">
						{{ __('UPDATE ASSIGNED SERIES') }}
						<a href="{{ route('withrawal.series.list') }}" class="btn btn-primary text-primary">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								...
								@livewire('wthdrwl-srs.withdrawal-series-update', ['id' => $with_series_id])
								{{-- @endif --}}
							</div>
						</div>
					</div>
