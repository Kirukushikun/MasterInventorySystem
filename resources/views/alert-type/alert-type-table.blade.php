		...
		<div class="row">
			<div class="col-md-12">
				<div class="header">
					<h4 class="title">
						{{ __('NOTIFICATION TYPE LIST') }}
						<a href="{{ route('alert.type.div') }}" class="btn btn-primary text-primary">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
                                <table id="alert_type" class="table table-hover" style="width: 100%;">
                                    <thead>
...
@section('scriptss')
	...
	<script>
        ...
        $(document).ready(function () {
            alert_type = jQuery('#alert_type').DataTable({
                processing: true,
                serverSide: false,
                scrollX: true,
                columnDefs: [
        ...
        $(document).on('click', '#refresh', function(e) {
            alert_type = $('#alert_type').DataTable();
                $('#series_location').val('');
            var nurl = "/farm/location/list/all/fl/rf";
            alert_type.ajax.url(nurl).load();
