		...
		<div class="row">
			<div class="col-md-12">
				<div class="header">
					<h4 class="title">
						{{ __('Bin Location List') }}
						<a href="{{ route('location.div') }}" class="btn btn-primary text-primary">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
                                <table id="location" class="table table-hover" style="width: 100%;">
                                    <thead>
...
@section('scriptss')
	...
	<script>
        ...
        $(document).ready(function () {
            locationTable = jQuery('#location').DataTable({
                processing: true,
                serverSide: false,
                scrollX: true,
                columnDefs: [
